...
<script type="text/javascript" src="assets/js/validatePassword.js"></script>
</head>
		...
		<div class="col-md-8 offset-md-2" for="dropdown-input-field">
			<form class="custom-form" action="Signup" method="post">
				...
				<div class="form-row form-group">
					...
					<div class="col-sm-6 input-column">
						<input class="form-control"  id="rpassword" type="password" name="rpassword" required="" onchange="validate()">
					</div>
				</div>
