...
<link rel="stylesheet" href="assets/css/profile_span.css">
			...
			<div id="content">
						...
						<ul class="nav navbar-nav flex-nowrap ml-auto">
							...
							<li role="presentation" class="nav-item dropdown no-arrow mx-1">
								<div class="nav-item dropdown no-arrow">
									<a role="presentation"  aria-expanded="false" href="updateProfileStudent.jsp"
											class="dropdown-toggle nav-link">Update Profile</a>
								</div>
							</li>
				...
				<div class="container-fluid">
					...
					<div class="row mb-3">
						...
						<h6 class="text-primary font-weight-bold m-0">Attendance<br></h6>
								...
								<%
										...
										while(true)
										{
											...
											String sub="sub"+Integer.toString(i);
											String subper="subper"+Integer.toString(i);
											String subject=(String)session.getAttribute(sub);
											String per=(String)session.getAttribute(subper);
											if(subject==null||subject.equals("null"))
												break;
											String result="<div class=\"card-body\"><h4 class=\"small font-weight-bold\">"+subject+"<span class=\"float-right\">"+per+"%</span></h4><div class=\"progress progress-sm mb-3\"><div class=\"progress-bar bg-danger\" aria-valuenow=\""+per+"\" aria-valuemin=\"0\" aria-valuemax=\""+per+"\" style=\"width: "+per+"%;\"><span class=\"sr-only\">"+per+"%</span></div></div></div>";
											out.println(result);	
											i++;
										}
													...
													<div class="col">
														<div class="form-group">
															<label for="email"><strong>Course</strong></label><input
																...
																value= <%= session.getAttribute("courseShow")%> disabled>
														</div>
													</div>
												<div class="col">
														<div class="form-group">
